...
for i in range(1, 41):
    audioDict['1-2-' + str(i)] = pygame.mixer.Sound("Audio/Node Audio/com1lvl2/C1L2-" + str(i) + ".wav")
for i in range(1, 21):
    audioDict['2-2-' + str(i)] = pygame.mixer.Sound("Audio/Node Audio/com2lvl2/C2L2-" + str(i) + ".wav")
for i in range(1, 17):
    audioDict['2-3-' + str(i)] = pygame.mixer.Sound("Audio/Node Audio/com2lvl3/C2L3-" + str(i) + ".wav")
